...
db = client_mongo["chatbot_gokulab"]
coleccion = db["conversaciones"]
client_groq = Groq(api_key=os.getenv("GROQ_API_KEY"))

# ========== CARGAR Y ENTRENAR CLASIFICADOR ==========
...
def chat():
    ...
    Si no tienes información suficiente, invita al usuario a contactar por WhatsApp: {config.get('whatsapp', '')}.
    """
